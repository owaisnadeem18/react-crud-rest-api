...
const Header = ({input , setInput , updateData , isEdit , setUpdateData , data , setData}) => {
  ...
  return (
    <form onSubmit={(e) => handleSubmit(e , input , setUpdateData , updateData?.id , setInput , data , setData )} >
